...
<div class="row" id="Accueil">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color: rgb(236,240,241);">
		
		<button class="precedent btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-up"></span></button>
		
		<h4>NOTRE BUT EST DE SENSIBILISER LES POPULATIONS</h4>
	...
	<div style="background-color: rgb(63,195,128);" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<button class="precedent btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-up"></span></button>
		<h3>FAITES LE BON GESTE </h3>
		<P>
			Durant votre visite sur ce site vous pourrez signalez differents incident en allant sur
			l’onglet INCIDENT , vous pourrez aussi nous faire parvenir des  suggestions par 
			rapport  comment les choses se passent sur le terrain. Si vous voulez  vous informer
			par rapport aux differentes zone signalees dans la ville d’abidjan vous pouvez aussi 
			consulter notre carte en cliquant sur l’onglet  Geolocalisation .
		</P>
